...
The course will give an overview of R as an instrument for programming and efficient scripting.
...
In R, we are able to work with files by interacting with the host OS and filesystem.
...
Base R functions for manipulating basic data structures.
...
*Scoping* is divided in both static and dynamic.
